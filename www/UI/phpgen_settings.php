...
{
    $result = array();
    $result[] = array('caption' => 'Operations', 'short_caption' => 'Operations', 'filename' => 'operationpc.php', 'name' => 'operationpc', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Agents', 'short_caption' => 'Agents', 'filename' => 'agent.php', 'name' => 'agent', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Sessions', 'short_caption' => 'Sessions', 'filename' => 'computer.php', 'name' => 'computer', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Commands', 'short_caption' => 'Commands', 'filename' => 'commands.php', 'name' => 'commands', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Automation', 'short_caption' => 'Automation', 'filename' => 'cmd_auto.php', 'name' => 'cmd_auto', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Attacks', 'short_caption' => 'Attacks', 'filename' => 'command_list.php', 'name' => 'command_list', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Attacks Categories', 'short_caption' => 'Categories', 'filename' => 'category_cmd.php', 'name' => 'category_cmd', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
