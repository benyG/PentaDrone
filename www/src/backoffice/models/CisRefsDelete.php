 ...
 * Page class
 */
class CisRefsDelete extends CisRefs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CisRefsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CisRefsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CisRefsList"); // Return to list
                return;
            }
        }
