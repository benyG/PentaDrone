 ...
 * Page class
 */
class SubcatCobitLinksDelete extends SubcatCobitLinks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubcatCobitLinksDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SubcatCobitLinksList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SubcatCobitLinksList"); // Return to list
                return;
            }
        }
