 ...
 * Page class
 */
class NistToIso27001Delete extends NistToIso27001
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NistToIso27001Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NistToIso27001List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NistToIso27001List"); // Return to list
                return;
            }
        }
