 ...
 * Page class
 */
class RiskLibrairiesGrid extends RiskLibrairies
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RiskLibrairiesGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "frisk_librairiesgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_layer") && $CurrentForm->hasValue("o_layer") && $this->layer->CurrentValue != $this->layer->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_tag") && $CurrentForm->hasValue("o_tag") && $this->tag->CurrentValue != $this->tag->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Confidentiality") && $CurrentForm->hasValue("o_Confidentiality") && $this->Confidentiality->CurrentValue != $this->Confidentiality->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Integrity") && $CurrentForm->hasValue("o_Integrity") && $this->Integrity->CurrentValue != $this->Integrity->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Availability") && $CurrentForm->hasValue("o_Availability") && $this->Availability->CurrentValue != $this->Availability->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Efficiency") && $CurrentForm->hasValue("o_Efficiency") && $this->Efficiency->CurrentValue != $this->Efficiency->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->layer->clearErrorMessage();
        $this->function_csf->clearErrorMessage();
        $this->tag->clearErrorMessage();
        $this->Confidentiality->clearErrorMessage();
        $this->Integrity->clearErrorMessage();
        $this->Availability->clearErrorMessage();
        $this->Efficiency->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->layer->CurrentValue = null;
        $this->layer->OldValue = $this->layer->CurrentValue;
        ...
        $this->Confidentiality->CurrentValue = null;
        $this->Confidentiality->OldValue = $this->Confidentiality->CurrentValue;
        $this->Integrity->CurrentValue = null;
        $this->Integrity->OldValue = $this->Integrity->CurrentValue;
        $this->Availability->CurrentValue = null;
        $this->Availability->OldValue = $this->Availability->CurrentValue;
        $this->Efficiency->CurrentValue = null;
        $this->Efficiency->OldValue = $this->Efficiency->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_layer")) {
            $this->layer->setOldValue($CurrentForm->getValue("o_layer"));
        }
        ...
        if ($CurrentForm->hasValue("o_tag")) {
            $this->tag->setOldValue($CurrentForm->getValue("o_tag"));
        }
        ...
        if ($CurrentForm->hasValue("o_Confidentiality")) {
            $this->Confidentiality->setOldValue($CurrentForm->getValue("o_Confidentiality"));
        }
        ...
        if ($CurrentForm->hasValue("o_Integrity")) {
            $this->Integrity->setOldValue($CurrentForm->getValue("o_Integrity"));
        }
        ...
        if ($CurrentForm->hasValue("o_Availability")) {
            $this->Availability->setOldValue($CurrentForm->getValue("o_Availability"));
        }
        ...
        if ($CurrentForm->hasValue("o_Efficiency")) {
            $this->Efficiency->setOldValue($CurrentForm->getValue("o_Efficiency"));
        }
    }
    ...
    protected function newRow()
    {
        ...
        $row['layer'] = $this->layer->CurrentValue;
        $row['function_csf'] = $this->function_csf->CurrentValue;
        $row['tag'] = $this->tag->CurrentValue;
        $row['Confidentiality'] = $this->Confidentiality->CurrentValue;
        $row['Integrity'] = $this->Integrity->CurrentValue;
        $row['Availability'] = $this->Availability->CurrentValue;
        $row['Efficiency'] = $this->Efficiency->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "layers") {
            $this->layer->CurrentValue = $this->layer->getSessionValue();
        }
        ...
        // layer
        $this->layer->setDbValueDef($rsnew, $this->layer->CurrentValue, "", false);

        // function_csf
        $this->function_csf->setDbValueDef($rsnew, $this->function_csf->CurrentValue, "", false);

        // tag
        $this->tag->setDbValueDef($rsnew, $this->tag->CurrentValue, "", false);

        // Confidentiality
        $this->Confidentiality->setDbValueDef($rsnew, $this->Confidentiality->CurrentValue, 0, false);

        // Integrity
        $this->Integrity->setDbValueDef($rsnew, $this->Integrity->CurrentValue, 0, false);

        // Availability
        $this->Availability->setDbValueDef($rsnew, $this->Availability->CurrentValue, 0, false);

        // Efficiency
        $this->Efficiency->setDbValueDef($rsnew, $this->Efficiency->CurrentValue, 0, false);
