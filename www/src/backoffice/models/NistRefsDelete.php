 ...
 * Page class
 */
class NistRefsDelete extends NistRefs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NistRefsDelete";
    ...
    public function run()
    {
        ...
        $this->discussion->Visible = false;
        $this->related_controls->Visible = false;
        ...
        if ($filter == "") {
            $this->terminate("NistRefsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("NistRefsList"); // Return to list
                return;
            }
        }
