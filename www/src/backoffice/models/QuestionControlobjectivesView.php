 ...
 * Page class
 */
class QuestionControlobjectivesView extends QuestionControlobjectives
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuestionControlobjectivesView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("controlObj_name") ?? Route("controlObj_name")) !== null) {
            $this->RecKey["controlObj_name"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("controlObj_name") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("controlObj_name");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("controlObj_name") ?? Route("controlObj_name")) !== null) {
                ...
                $this->RecKey["controlObj_name"] = $this->controlObj_name->QueryStringValue;
            } elseif (Post("controlObj_name") !== null) {
                $this->controlObj_name->setFormValue(Post("controlObj_name"));
                $this->RecKey["controlObj_name"] = $this->controlObj_name->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("QuestionControlobjectivesList"); // Return to list page
                        return;
                        ...
                        while (!$this->Recordset->EOF) {
                            if (SameString($this->controlObj_name->CurrentValue, $this->Recordset->fields['controlObj_name'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "QuestionControlobjectivesList"; // No matching record, return to list
                    } else {
            ...
            $returnUrl = "QuestionControlobjectivesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("QuestionsLibraryList?" . Config("TABLE_SHOW_MASTER") . "=question_controlobjectives&" . GetForeignKeyUrl("fk_controlObj_name", $this->controlObj_name->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("QuestionsLibraryGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'question_controlobjectives')) {
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'question_controlobjectives')) {
        ...
        if ($detailPageObj->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'question_controlobjectives')) {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fquestion_controlobjectivesview, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fquestion_controlobjectivesview, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fquestion_controlobjectivesview, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
