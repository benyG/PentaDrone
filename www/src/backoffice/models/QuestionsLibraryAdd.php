 ...
 * Page class
 */
class QuestionsLibraryAdd extends QuestionsLibrary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuestionsLibraryAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("QuestionsLibraryList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "QuestionsLibraryView") {
