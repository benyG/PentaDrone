 ...
 * Page class
 */
class Iso27001RefsDelete extends Iso27001Refs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Iso27001RefsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Iso27001RefsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Iso27001RefsList"); // Return to list
                return;
            }
        }
