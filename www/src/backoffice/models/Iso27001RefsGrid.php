 ...
 * Page class
 */
class Iso27001RefsGrid extends Iso27001Refs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Iso27001RefsGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fiso27001_refsgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_control_familyName_id") && $CurrentForm->hasValue("o_control_familyName_id") && $this->control_familyName_id->CurrentValue != $this->control_familyName_id->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_control_ID") && $CurrentForm->hasValue("o_control_ID") && $this->control_ID->CurrentValue != $this->control_ID->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->control_familyName_id->clearErrorMessage();
        $this->control_name->clearErrorMessage();
        $this->control_ID->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_control_familyName_id")) {
            $this->control_familyName_id->setOldValue($CurrentForm->getValue("o_control_familyName_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_control_ID")) {
            $this->control_ID->setOldValue($CurrentForm->getValue("o_control_ID"));
        }
    }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // control_familyName_id
            if ($this->control_familyName_id->getSessionValue() != "") {
                $this->control_familyName_id->ReadOnly = true;
            }
            $this->control_familyName_id->setDbValueDef($rsnew, $this->control_familyName_id->CurrentValue, "", $this->control_familyName_id->ReadOnly);

            // control_name
            $this->control_name->setDbValueDef($rsnew, $this->control_name->CurrentValue, "", $this->control_name->ReadOnly);

            // control_ID
            $this->control_ID->setDbValueDef($rsnew, $this->control_ID->CurrentValue, "", $this->control_ID->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "iso27001_family") {
            $this->control_familyName_id->CurrentValue = $this->control_familyName_id->getSessionValue();
        }
        $conn = $this->getConnection();
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "iso27001_family") {
            $masterTbl = Container("iso27001_family");
            $this->control_familyName_id->Visible = false;
