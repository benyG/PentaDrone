 ...
 * Page class
 */
class Cobit5AreaAdd extends Cobit5Area
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Cobit5AreaAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("Cobit5AreaList"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "Cobit5AreaList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "Cobit5AreaView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("cobit5_family", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("Cobit5FamilyGrid");
            if (in_array("cobit5_family", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->control_area_id->setSessionValue($this->code->CurrentValue); // Set master key
