 ...
 * Page class
 */
class InformationsDelete extends Informations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InformationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("InformationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("InformationsList"); // Return to list
                return;
            }
        }
