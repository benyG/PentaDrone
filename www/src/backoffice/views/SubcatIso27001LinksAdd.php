...
// Page object
$SubcatIso27001LinksAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fsubcat_iso27001_linksadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fsubcat_iso27001_linksadd = currentForm = new ew.Form("fsubcat_iso27001_linksadd", "add");
    ...
    fsubcat_iso27001_linksadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fsubcat_iso27001_linksadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fsubcat_iso27001_linksadd.validate = function () {
    ...
    // Form_CustomValidate
    fsubcat_iso27001_linksadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsubcat_iso27001_linksadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fsubcat_iso27001_linksadd.lists.iso27001_code = <?= $Page->iso27001_code->toClientList($Page) ?>;
    fsubcat_iso27001_linksadd.lists.subcat_id = <?= $Page->subcat_id->toClientList($Page) ?>;
    loadjs.done("fsubcat_iso27001_linksadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fsubcat_iso27001_linksadd" id="fsubcat_iso27001_linksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fsubcat_iso27001_linksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsubcat_iso27001_linksadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fsubcat_iso27001_linksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsubcat_iso27001_linksadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
