...
// Page object
$QuestionAreasEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fquestion_areasedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fquestion_areasedit = currentForm = new ew.Form("fquestion_areasedit", "edit");
    ...
    // Validate form
    fquestion_areasedit.validate = function () {
    ...
    // Form_CustomValidate
    fquestion_areasedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fquestion_areasedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fquestion_areasedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fquestion_areasedit" id="fquestion_areasedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="question_areas" data-field="x_area_name" data-hidden="1" name="o_area_name" id="o_area_name" value="<?= HtmlEncode($Page->area_name->OldValue ?? $Page->area_name->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fquestion_areasedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fquestion_areasedit", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fquestion_areasedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fquestion_areasedit", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php
    if (in_array("question_domains", explode(",", $Page->getCurrentDetailTable())) && $question_domains->DetailEdit) {
?>
