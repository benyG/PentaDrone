...
// Page object
$SubcatCisLinksAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fsubcat_cis_linksadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fsubcat_cis_linksadd = currentForm = new ew.Form("fsubcat_cis_linksadd", "add");
    ...
    fsubcat_cis_linksadd.addFields([
    ...
    // Validate form
    fsubcat_cis_linksadd.validate = function () {
    ...
    // Form_CustomValidate
    fsubcat_cis_linksadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsubcat_cis_linksadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fsubcat_cis_linksadd.lists.subcat_id = <?= $Page->subcat_id->toClientList($Page) ?>;
    fsubcat_cis_linksadd.lists.cisrefs_id = <?= $Page->cisrefs_id->toClientList($Page) ?>;
    loadjs.done("fsubcat_cis_linksadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fsubcat_cis_linksadd" id="fsubcat_cis_linksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fsubcat_cis_linksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsubcat_cis_linksadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fsubcat_cis_linksadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fsubcat_cis_linksadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
