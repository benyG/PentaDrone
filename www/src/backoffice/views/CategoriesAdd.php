...
<script>
loadjs.ready(["fcategoriesadd", "editor"], function() {
	ew.createEditor("fcategoriesadd", "x_description", 35, 4, <?= $Page->description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
loadjs.ready(["fcategoriesadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fcategoriesadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fcategoriesadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fcategoriesadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php
    if (in_array("sub_categories", explode(",", $Page->getCurrentDetailTable())) && $sub_categories->DetailAdd) {
?>
