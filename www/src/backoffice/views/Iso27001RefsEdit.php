...
// Page object
$Iso27001RefsEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fiso27001_refsedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fiso27001_refsedit = currentForm = new ew.Form("fiso27001_refsedit", "edit");
    ...
    // Validate form
    fiso27001_refsedit.validate = function () {
    ...
    // Form_CustomValidate
    fiso27001_refsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fiso27001_refsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fiso27001_refsedit.lists.control_familyName_id = <?= $Page->control_familyName_id->toClientList($Page) ?>;
    loadjs.done("fiso27001_refsedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fiso27001_refsedit" id="fiso27001_refsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="iso27001_refs" data-field="x_code" data-hidden="1" name="o_code" id="o_code" value="<?= HtmlEncode($Page->code->OldValue ?? $Page->code->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fiso27001_refsedit", "editor"], function() {
	ew.createEditor("fiso27001_refsedit", "x_description", 35, 4, <?= $Page->description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
