...
// Page object
$RiskControlLinksAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var frisk_control_linksadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    frisk_control_linksadd = currentForm = new ew.Form("frisk_control_linksadd", "add");
    ...
    frisk_control_linksadd.addFields([
    ...
    // Validate form
    frisk_control_linksadd.validate = function () {
    ...
    // Form_CustomValidate
    frisk_control_linksadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frisk_control_linksadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    frisk_control_linksadd.lists.control_foreign_id = <?= $Page->control_foreign_id->toClientList($Page) ?>;
    frisk_control_linksadd.lists.risk_foreign_id = <?= $Page->risk_foreign_id->toClientList($Page) ?>;
    loadjs.done("frisk_control_linksadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frisk_control_linksadd" id="frisk_control_linksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
