...
// Page object
$ControlsLibraryAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcontrols_libraryadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcontrols_libraryadd = currentForm = new ew.Form("fcontrols_libraryadd", "add");
    ...
    fcontrols_libraryadd.addFields([
    ...
    // Validate form
    fcontrols_libraryadd.validate = function () {
    ...
    // Form_CustomValidate
    fcontrols_libraryadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcontrols_libraryadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcontrols_libraryadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcontrols_libraryadd" id="fcontrols_libraryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fcontrols_libraryadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fcontrols_libraryadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fcontrols_libraryadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fcontrols_libraryadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php
    if (in_array("layer_controls_links", explode(",", $Page->getCurrentDetailTable())) && $layer_controls_links->DetailAdd) {
?>
...
<?php } ?>
<?php
    if (in_array("risk_control_links", explode(",", $Page->getCurrentDetailTable())) && $risk_control_links->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
