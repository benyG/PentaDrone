...
// Page object
$NistRefsControlareaAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnist_refs_controlareaadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fnist_refs_controlareaadd = currentForm = new ew.Form("fnist_refs_controlareaadd", "add");
    ...
    fnist_refs_controlareaadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fnist_refs_controlareaadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fnist_refs_controlareaadd.validate = function () {
    ...
    // Form_CustomValidate
    fnist_refs_controlareaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnist_refs_controlareaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fnist_refs_controlareaadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnist_refs_controlareaadd" id="fnist_refs_controlareaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
