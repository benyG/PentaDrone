...
loadjs.ready("head", function () {
    ...
    fcobit5_refsadd = currentForm = new ew.Form("fcobit5_refsadd", "add");
    ...
    // Validate form
    fcobit5_refsadd.validate = function () {
    ...
    // Form_CustomValidate
    fcobit5_refsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcobit5_refsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcobit5_refsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcobit5_refsadd" id="fcobit5_refsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
