...
// Page object
$NistRefsControlfamilyAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnist_refs_controlfamilyadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fnist_refs_controlfamilyadd = currentForm = new ew.Form("fnist_refs_controlfamilyadd", "add");
    ...
    fnist_refs_controlfamilyadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fnist_refs_controlfamilyadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fnist_refs_controlfamilyadd.validate = function () {
    ...
    // Form_CustomValidate
    fnist_refs_controlfamilyadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnist_refs_controlfamilyadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fnist_refs_controlfamilyadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnist_refs_controlfamilyadd" id="fnist_refs_controlfamilyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php
    if (in_array("nist_refs", explode(",", $Page->getCurrentDetailTable())) && $nist_refs->DetailAdd) {
?>
