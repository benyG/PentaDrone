 ...
 * Page class
 */
class Cobit5AreaDelete extends Cobit5Area
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Cobit5AreaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Cobit5AreaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Cobit5AreaList"); // Return to list
                return;
            }
        }
