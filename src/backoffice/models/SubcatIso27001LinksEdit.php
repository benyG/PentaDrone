 ...
 * Page class
 */
class SubcatIso27001LinksEdit extends SubcatIso27001Links
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubcatIso27001LinksEdit";
        ...
        if (IsApi()) {
            ...
            if ($this->isShow()) {
                ...
                if ($this->TotalRecords <= 0) { // No record found
                    ...
                    $this->terminate("SubcatIso27001LinksList"); // Return to list page
                    return;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // iso27001_code
            if ($this->iso27001_code->getSessionValue() != "") {
                $this->iso27001_code->ReadOnly = true;
            }
            $this->iso27001_code->setDbValueDef($rsnew, $this->iso27001_code->CurrentValue, "", $this->iso27001_code->ReadOnly);
