 ...
 * Page class
 */
class QuestionsLibraryDelete extends QuestionsLibrary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuestionsLibraryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("QuestionsLibraryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("QuestionsLibraryList"); // Return to list
                return;
            }
        }
