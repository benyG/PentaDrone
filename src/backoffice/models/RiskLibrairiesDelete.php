 ...
 * Page class
 */
class RiskLibrairiesDelete extends RiskLibrairies
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RiskLibrairiesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RiskLibrairiesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RiskLibrairiesList"); // Return to list
                return;
            }
        }
