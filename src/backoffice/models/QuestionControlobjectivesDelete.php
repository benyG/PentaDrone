 ...
 * Page class
 */
class QuestionControlobjectivesDelete extends QuestionControlobjectives
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuestionControlobjectivesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("QuestionControlobjectivesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("QuestionControlobjectivesList"); // Return to list
                return;
            }
        }
