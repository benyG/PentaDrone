 ...
 * Page class
 */
class ThreatsDelete extends Threats
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ThreatsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ThreatsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ThreatsList"); // Return to list
                return;
            }
        }
