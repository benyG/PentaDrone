 ...
 * Page class
 */
class InventoriesAdd extends Inventories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InventoriesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("InventoriesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "InventoriesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "InventoriesView") {
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->org_id->FormValue)) {
            $this->org_id->addErrorMessage($this->org_id->getErrorMessage(false));
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // org_id
        $this->org_id->setDbValueDef($rsnew, $this->org_id->CurrentValue, 0, false);
