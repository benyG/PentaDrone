 ...
 * Page class
 */
class SubcatCobitLinksGrid extends SubcatCobitLinks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubcatCobitLinksGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fsubcat_cobit_linksgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_cobitrefs_id") && $CurrentForm->hasValue("o_cobitrefs_id") && $this->cobitrefs_id->CurrentValue != $this->cobitrefs_id->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->cobitrefs_id->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->cobitrefs_id->CurrentValue = null;
        $this->cobitrefs_id->OldValue = $this->cobitrefs_id->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_cobitrefs_id")) {
            $this->cobitrefs_id->setOldValue($CurrentForm->getValue("o_cobitrefs_id"));
        }
    }
    ...
    protected function newRow()
    {
        ...
        $row['cobitrefs_id'] = $this->cobitrefs_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "cobit5_refs") {
            $this->cobitrefs_id->CurrentValue = $this->cobitrefs_id->getSessionValue();
        }
        if ($this->getCurrentMasterTable() == "sub_categories") {
            $this->subcat_id->CurrentValue = $this->subcat_id->getSessionValue();
        }

        // Check referential integrity for master table 'subcat_cobit_links'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_cobit5_refs();
        if (strval($this->cobitrefs_id->CurrentValue) != "") {
            $masterFilter = str_replace("@NIdentifier@", AdjustSql($this->cobitrefs_id->CurrentValue, "DB"), $masterFilter);
        } else {
            $validMasterRecord = false;
        }
        if ($validMasterRecord) {
        ...
        // cobitrefs_id
        $this->cobitrefs_id->setDbValueDef($rsnew, $this->cobitrefs_id->CurrentValue, "", false);
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "cobit5_refs") {
            $masterTbl = Container("cobit5_refs");
            $this->cobitrefs_id->Visible = false;
