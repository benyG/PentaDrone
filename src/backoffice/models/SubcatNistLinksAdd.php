 ...
 * Page class
 */
class SubcatNistLinksAdd extends SubcatNistLinks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubcatNistLinksAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("SubcatNistLinksList"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "SubcatNistLinksList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "SubcatNistLinksView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("nist_refs_controlfamily", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("NistRefsControlfamilyGrid");
            if (in_array("nist_refs_controlfamily", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->code->setSessionValue($this->nistrefs_id->CurrentValue); // Set master key
