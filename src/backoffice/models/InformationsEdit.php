 ...
 * Page class
 */
class InformationsEdit extends Informations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InformationsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // people_id
            $this->people_id->setDbValueDef($rsnew, $this->people_id->CurrentValue, 0, $this->people_id->ReadOnly);
            ...
            // asset_value
            $this->asset_value->setDbValueDef($rsnew, $this->asset_value->CurrentValue, null, $this->asset_value->ReadOnly);

            // business_value
            $this->business_value->setDbValueDef($rsnew, $this->business_value->CurrentValue, "", $this->business_value->ReadOnly);

            // criticality_points
            $this->criticality_points->setDbValueDef($rsnew, $this->criticality_points->CurrentValue, 0, $this->criticality_points->ReadOnly);
