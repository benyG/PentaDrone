 ...
 * Page class
 */
class QuestionsLibraryGrid extends QuestionsLibrary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QuestionsLibraryGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fquestions_librarygrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "iso27001_refs") {
            $this->refs1->CurrentValue = $this->refs1->getSessionValue();
        }
        if ($this->getCurrentMasterTable() == "nist_to_iso27001") {
            $this->refs1->CurrentValue = $this->refs1->getSessionValue();
        }
        if ($this->getCurrentMasterTable() == "question_controlobjectives") {
            $this->controlObj_id->CurrentValue = $this->controlObj_id->getSessionValue();
        }
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "question_controlobjectives") {
            $masterTbl = Container("question_controlobjectives");
            $this->controlObj_id->Visible = false;
            if ($masterTbl->EventCancelled) {
                $this->EventCancelled = true;
            }
        }
