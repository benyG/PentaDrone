 ...
 * Page class
 */
class SubcatNistLinksEdit extends SubcatNistLinks
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubcatNistLinksEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("nist_refs_controlfamily", $detailTblVar) && $detailPage->DetailEdit) {
