 ...
 * Page class
 */
class InventoriesEdit extends Inventories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InventoriesEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // org_id
            $this->org_id->setDbValueDef($rsnew, $this->org_id->CurrentValue, 0, $this->org_id->ReadOnly);
