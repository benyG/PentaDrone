 ...
 * Page class
 */
class Cobit5RefsGrid extends Cobit5Refs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Cobit5RefsGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fcobit5_refsgrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_code_cobitfamily") && $CurrentForm->hasValue("o_code_cobitfamily") && $this->code_cobitfamily->CurrentValue != $this->code_cobitfamily->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->code_cobitfamily->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_code_cobitfamily")) {
            $this->code_cobitfamily->setOldValue($CurrentForm->getValue("o_code_cobitfamily"));
        }
    }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // code_cobitfamily
            if ($this->code_cobitfamily->getSessionValue() != "") {
                $this->code_cobitfamily->ReadOnly = true;
            }
            $this->code_cobitfamily->setDbValueDef($rsnew, $this->code_cobitfamily->CurrentValue, "", $this->code_cobitfamily->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "cobit5_family") {
            $this->code_cobitfamily->CurrentValue = $this->code_cobitfamily->getSessionValue();
        }
        $conn = $this->getConnection();
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "cobit5_family") {
            $masterTbl = Container("cobit5_family");
            $this->code_cobitfamily->Visible = false;
