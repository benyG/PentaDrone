 ...
 * Page class
 */
class CisRefsGrid extends CisRefs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CisRefsGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fcis_refsgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nidentifier->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_Nidentifier") && $CurrentForm->hasValue("o_Nidentifier") && $this->Nidentifier->CurrentValue != $this->Nidentifier->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_Control_Family_id") && $CurrentForm->hasValue("o_Control_Family_id") && $this->Control_Family_id->CurrentValue != $this->Control_Family_id->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_control_Name") && $CurrentForm->hasValue("o_control_Name") && $this->control_Name->CurrentValue != $this->control_Name->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_impl_group1") && $CurrentForm->hasValue("o_impl_group1") && $this->impl_group1->CurrentValue != $this->impl_group1->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_impl_group2") && $CurrentForm->hasValue("o_impl_group2") && $this->impl_group2->CurrentValue != $this->impl_group2->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_impl_group3") && $CurrentForm->hasValue("o_impl_group3") && $this->impl_group3->CurrentValue != $this->impl_group3->OldValue) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->Nidentifier->clearErrorMessage();
        $this->Control_Family_id->clearErrorMessage();
        $this->control_Name->clearErrorMessage();
        $this->impl_group1->clearErrorMessage();
        $this->impl_group2->clearErrorMessage();
        $this->impl_group3->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->impl_group1->CurrentValue = null;
        $this->impl_group1->OldValue = $this->impl_group1->CurrentValue;
        $this->impl_group2->CurrentValue = null;
        $this->impl_group2->OldValue = $this->impl_group2->CurrentValue;
        $this->impl_group3->CurrentValue = null;
        $this->impl_group3->OldValue = $this->impl_group3->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_Control_Family_id")) {
            $this->Control_Family_id->setOldValue($CurrentForm->getValue("o_Control_Family_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_control_Name")) {
            $this->control_Name->setOldValue($CurrentForm->getValue("o_control_Name"));
        }

        // Check field name 'impl_group1' first before field var 'x_impl_group1'
        $val = $CurrentForm->hasValue("impl_group1") ? $CurrentForm->getValue("impl_group1") : $CurrentForm->getValue("x_impl_group1");
        if (!$this->impl_group1->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->impl_group1->Visible = false; // Disable update for API request
            } else {
                $this->impl_group1->setFormValue($val);
            }
        }
        if ($CurrentForm->hasValue("o_impl_group1")) {
            $this->impl_group1->setOldValue($CurrentForm->getValue("o_impl_group1"));
        }

        // Check field name 'impl_group2' first before field var 'x_impl_group2'
        $val = $CurrentForm->hasValue("impl_group2") ? $CurrentForm->getValue("impl_group2") : $CurrentForm->getValue("x_impl_group2");
        if (!$this->impl_group2->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->impl_group2->Visible = false; // Disable update for API request
            } else {
                $this->impl_group2->setFormValue($val);
            }
        }
        if ($CurrentForm->hasValue("o_impl_group2")) {
            $this->impl_group2->setOldValue($CurrentForm->getValue("o_impl_group2"));
        }

        // Check field name 'impl_group3' first before field var 'x_impl_group3'
        $val = $CurrentForm->hasValue("impl_group3") ? $CurrentForm->getValue("impl_group3") : $CurrentForm->getValue("x_impl_group3");
        if (!$this->impl_group3->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->impl_group3->Visible = false; // Disable update for API request
            } else {
                $this->impl_group3->setFormValue($val);
            }
        }
        if ($CurrentForm->hasValue("o_impl_group3")) {
            $this->impl_group3->setOldValue($CurrentForm->getValue("o_impl_group3"));
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        $this->impl_group1->CurrentValue = $this->impl_group1->FormValue;
        $this->impl_group2->CurrentValue = $this->impl_group2->FormValue;
        $this->impl_group3->CurrentValue = $this->impl_group3->FormValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['impl_group1'] = $this->impl_group1->CurrentValue;
        $row['impl_group2'] = $this->impl_group2->CurrentValue;
        $row['impl_group3'] = $this->impl_group3->CurrentValue;
        return $row;
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->impl_group1->EditValue = HtmlEncode($this->impl_group1->CurrentValue);
            ...
            $this->impl_group2->EditValue = HtmlEncode($this->impl_group2->CurrentValue);
            ...
            $this->impl_group3->EditValue = HtmlEncode($this->impl_group3->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->impl_group1->Required) {
            if (!$this->impl_group1->IsDetailKey && EmptyValue($this->impl_group1->FormValue)) {
                $this->impl_group1->addErrorMessage(str_replace("%s", $this->impl_group1->caption(), $this->impl_group1->RequiredErrorMessage));
            }
        }
        if ($this->impl_group2->Required) {
            if (!$this->impl_group2->IsDetailKey && EmptyValue($this->impl_group2->FormValue)) {
                $this->impl_group2->addErrorMessage(str_replace("%s", $this->impl_group2->caption(), $this->impl_group2->RequiredErrorMessage));
            }
        }
        if ($this->impl_group3->Required) {
            if (!$this->impl_group3->IsDetailKey && EmptyValue($this->impl_group3->FormValue)) {
                $this->impl_group3->addErrorMessage(str_replace("%s", $this->impl_group3->caption(), $this->impl_group3->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // impl_group1
            $this->impl_group1->setDbValueDef($rsnew, $this->impl_group1->CurrentValue, null, $this->impl_group1->ReadOnly);

            // impl_group2
            $this->impl_group2->setDbValueDef($rsnew, $this->impl_group2->CurrentValue, null, $this->impl_group2->ReadOnly);

            // impl_group3
            $this->impl_group3->setDbValueDef($rsnew, $this->impl_group3->CurrentValue, null, $this->impl_group3->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "cis_refs_controlfamily") {
            $this->Control_Family_id->CurrentValue = $this->Control_Family_id->getSessionValue();
        }
        $conn = $this->getConnection();
        ...
        // impl_group1
        $this->impl_group1->setDbValueDef($rsnew, $this->impl_group1->CurrentValue, null, false);

        // impl_group2
        $this->impl_group2->setDbValueDef($rsnew, $this->impl_group2->CurrentValue, null, false);

        // impl_group3
        $this->impl_group3->setDbValueDef($rsnew, $this->impl_group3->CurrentValue, null, false);
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "cis_refs_controlfamily") {
            $masterTbl = Container("cis_refs_controlfamily");
            $this->Control_Family_id->Visible = false;
