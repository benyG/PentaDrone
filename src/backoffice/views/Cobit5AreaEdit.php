...
var fcobit5_areaedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fcobit5_areaedit = currentForm = new ew.Form("fcobit5_areaedit", "edit");
    ...
    // Validate form
    fcobit5_areaedit.validate = function () {
    ...
    // Form_CustomValidate
    fcobit5_areaedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcobit5_areaedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcobit5_areaedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fcobit5_areaedit" id="fcobit5_areaedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="cobit5_area" data-field="x_code" data-hidden="1" name="o_code" id="o_code" value="<?= HtmlEncode($Page->code->OldValue ?? $Page->code->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<?php
    if (in_array("cobit5_family", explode(",", $Page->getCurrentDetailTable())) && $cobit5_family->DetailEdit) {
?>
