...
// Page object
$LayerQuestionLinksAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var flayer_question_linksadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    flayer_question_linksadd = currentForm = new ew.Form("flayer_question_linksadd", "add");
    ...
    flayer_question_linksadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = flayer_question_linksadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    flayer_question_linksadd.validate = function () {
    ...
    // Form_CustomValidate
    flayer_question_linksadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flayer_question_linksadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("flayer_question_linksadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="flayer_question_linksadd" id="flayer_question_linksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
