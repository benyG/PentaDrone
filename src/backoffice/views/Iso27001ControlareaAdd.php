...
// Page object
$Iso27001ControlareaAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fiso27001_controlareaadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fiso27001_controlareaadd = currentForm = new ew.Form("fiso27001_controlareaadd", "add");
    ...
    fiso27001_controlareaadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fiso27001_controlareaadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fiso27001_controlareaadd.validate = function () {
    ...
    // Form_CustomValidate
    fiso27001_controlareaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fiso27001_controlareaadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fiso27001_controlareaadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fiso27001_controlareaadd" id="fiso27001_controlareaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php
    if (in_array("iso27001_family", explode(",", $Page->getCurrentDetailTable())) && $iso27001_family->DetailAdd) {
?>
