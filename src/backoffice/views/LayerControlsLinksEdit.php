...
// Page object
$LayerControlsLinksEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var flayer_controls_linksedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    flayer_controls_linksedit = currentForm = new ew.Form("flayer_controls_linksedit", "edit");
    ...
    flayer_controls_linksedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = flayer_controls_linksedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    flayer_controls_linksedit.validate = function () {
    ...
    // Form_CustomValidate
    flayer_controls_linksedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flayer_controls_linksedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("flayer_controls_linksedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="flayer_controls_linksedit" id="flayer_controls_linksedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_layer_controls_links_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_layer_controls_links_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="layer_controls_links" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
