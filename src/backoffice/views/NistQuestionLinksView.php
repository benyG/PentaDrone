...
// Page object
$NistQuestionLinksView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fnist_question_linksview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fnist_question_linksview = currentForm = new ew.Form("fnist_question_linksview", "view");
    loadjs.done("fnist_question_linksview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<?php } ?>
<form name="fnist_question_linksview" id="fnist_question_linksview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_nist_question_links_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->question_foreign_id->Visible) { // question_foreign_id ?>
    <tr id="r_question_foreign_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_nist_question_links_question_foreign_id"><?= $Page->question_foreign_id->caption() ?></span></td>
...
<?php if ($Page->nistrefs_id->Visible) { // nistrefs_id ?>
    <tr id="r_nistrefs_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_nist_question_links_nistrefs_id"><?= $Page->nistrefs_id->caption() ?></span></td>
