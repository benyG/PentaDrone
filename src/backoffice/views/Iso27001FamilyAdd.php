...
// Page object
$Iso27001FamilyAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fiso27001_familyadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fiso27001_familyadd = currentForm = new ew.Form("fiso27001_familyadd", "add");
    ...
    // Validate form
    fiso27001_familyadd.validate = function () {
    ...
    // Form_CustomValidate
    fiso27001_familyadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fiso27001_familyadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fiso27001_familyadd.lists.control_area_id = <?= $Page->control_area_id->toClientList($Page) ?>;
    loadjs.done("fiso27001_familyadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fiso27001_familyadd" id="fiso27001_familyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fiso27001_familyadd", "editor"], function() {
	ew.createEditor("fiso27001_familyadd", "x_description", 35, 4, <?= $Page->description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
<?php
    if (in_array("iso27001_refs", explode(",", $Page->getCurrentDetailTable())) && $iso27001_refs->DetailAdd) {
?>
