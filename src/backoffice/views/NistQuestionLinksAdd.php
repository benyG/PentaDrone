...
// Page object
$NistQuestionLinksAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnist_question_linksadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fnist_question_linksadd = currentForm = new ew.Form("fnist_question_linksadd", "add");
    ...
    fnist_question_linksadd.addFields([
    ...
    // Validate form
    fnist_question_linksadd.validate = function () {
    ...
    // Form_CustomValidate
    fnist_question_linksadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnist_question_linksadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fnist_question_linksadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnist_question_linksadd" id="fnist_question_linksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
