...
// Page object
$NistToIso27001Add = &$Page;
?>
<script>
var currentForm, currentPageID;
var fnist_to_iso27001add;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fnist_to_iso27001add = currentForm = new ew.Form("fnist_to_iso27001add", "add");
    ...
    fnist_to_iso27001add.addFields([
    ...
    // Validate form
    fnist_to_iso27001add.validate = function () {
    ...
    // Form_CustomValidate
    fnist_to_iso27001add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnist_to_iso27001add.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fnist_to_iso27001add.lists.nistrefs_family = <?= $Page->nistrefs_family->toClientList($Page) ?>;
    fnist_to_iso27001add.lists.isorefs = <?= $Page->isorefs->toClientList($Page) ?>;
    loadjs.done("fnist_to_iso27001add");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnist_to_iso27001add" id="fnist_to_iso27001add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fnist_to_iso27001add", "datetimepicker"], function() {
    ew.createDateTimePicker("fnist_to_iso27001add", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fnist_to_iso27001add", "datetimepicker"], function() {
    ew.createDateTimePicker("fnist_to_iso27001add", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
