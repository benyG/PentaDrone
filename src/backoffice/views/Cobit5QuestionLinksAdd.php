...
// Page object
$Cobit5QuestionLinksAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcobit5_question_linksadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcobit5_question_linksadd = currentForm = new ew.Form("fcobit5_question_linksadd", "add");
    ...
    fcobit5_question_linksadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fcobit5_question_linksadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fcobit5_question_linksadd.validate = function () {
    ...
    // Form_CustomValidate
    fcobit5_question_linksadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcobit5_question_linksadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcobit5_question_linksadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcobit5_question_linksadd" id="fcobit5_question_linksadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
