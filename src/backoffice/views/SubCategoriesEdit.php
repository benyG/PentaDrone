...
// Page object
$SubCategoriesEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fsub_categoriesedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fsub_categoriesedit = currentForm = new ew.Form("fsub_categoriesedit", "edit");
    ...
    // Validate form
    fsub_categoriesedit.validate = function () {
    ...
    // Form_CustomValidate
    fsub_categoriesedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsub_categoriesedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fsub_categoriesedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<form name="fsub_categoriesedit" id="fsub_categoriesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="hidden" data-table="sub_categories" data-field="x_code_nist" data-hidden="1" name="o_code_nist" id="o_code_nist" value="<?= HtmlEncode($Page->code_nist->OldValue ?? $Page->code_nist->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fsub_categoriesedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fsub_categoriesedit", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fsub_categoriesedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fsub_categoriesedit", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php
    if (in_array("subcat_iso27001_links", explode(",", $Page->getCurrentDetailTable())) && $subcat_iso27001_links->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("subcat_cis_links", explode(",", $Page->getCurrentDetailTable())) && $subcat_cis_links->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("subcat_nist_links", explode(",", $Page->getCurrentDetailTable())) && $subcat_nist_links->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
