...
// Page object
$QuestionsLibraryAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fquestions_libraryadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fquestions_libraryadd = currentForm = new ew.Form("fquestions_libraryadd", "add");
    ...
    fquestions_libraryadd.addFields([
    ...
    // Validate form
    fquestions_libraryadd.validate = function () {
    ...
    // Form_CustomValidate
    fquestions_libraryadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fquestions_libraryadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fquestions_libraryadd.lists.controlObj_id = <?= $Page->controlObj_id->toClientList($Page) ?>;
    loadjs.done("fquestions_libraryadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fquestions_libraryadd" id="fquestions_libraryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fquestions_libraryadd", "editor"], function() {
	ew.createEditor("fquestions_libraryadd", "x_Evidence_to_request", 35, 4, <?= $Page->Evidence_to_request->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
<script>
loadjs.ready(["fquestions_libraryadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fquestions_libraryadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fquestions_libraryadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fquestions_libraryadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
