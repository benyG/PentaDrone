...
// Page object
$QuestionDomainsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fquestion_domainsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fquestion_domainsadd = currentForm = new ew.Form("fquestion_domainsadd", "add");
    ...
    fquestion_domainsadd.addFields([
    ...
    // Validate form
    fquestion_domainsadd.validate = function () {
    ...
    // Form_CustomValidate
    fquestion_domainsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fquestion_domainsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fquestion_domainsadd.lists.question_area_id = <?= $Page->question_area_id->toClientList($Page) ?>;
    loadjs.done("fquestion_domainsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fquestion_domainsadd" id="fquestion_domainsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fquestion_domainsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fquestion_domainsadd", "x_created_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fquestion_domainsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fquestion_domainsadd", "x_updated_at", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
