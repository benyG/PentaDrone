...
// Page object
$CisRefsControlfamilyAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcis_refs_controlfamilyadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcis_refs_controlfamilyadd = currentForm = new ew.Form("fcis_refs_controlfamilyadd", "add");
    ...
    fcis_refs_controlfamilyadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fcis_refs_controlfamilyadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fcis_refs_controlfamilyadd.validate = function () {
    ...
    // Form_CustomValidate
    fcis_refs_controlfamilyadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcis_refs_controlfamilyadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcis_refs_controlfamilyadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcis_refs_controlfamilyadd" id="fcis_refs_controlfamilyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php
    if (in_array("cis_refs", explode(",", $Page->getCurrentDetailTable())) && $cis_refs->DetailAdd) {
?>
