...
// Page object
$Cobit5FamilyAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcobit5_familyadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcobit5_familyadd = currentForm = new ew.Form("fcobit5_familyadd", "add");
    ...
    // Validate form
    fcobit5_familyadd.validate = function () {
    ...
    // Form_CustomValidate
    fcobit5_familyadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcobit5_familyadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcobit5_familyadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcobit5_familyadd" id="fcobit5_familyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php
    if (in_array("cobit5_refs", explode(",", $Page->getCurrentDetailTable())) && $cobit5_refs->DetailAdd) {
?>
