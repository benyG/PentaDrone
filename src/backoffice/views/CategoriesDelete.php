...
<?php if ($Page->code_nist->Visible) { // code_nist ?>
        <th class="<?= $Page->code_nist->headerCellClass() ?>"><span id="elh_categories_code_nist" class="categories_code_nist"><?= $Page->code_nist->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_categories_code_nist" class="categories_code_nist">
...
<span id="el<?= $Page->RowCount ?>_categories_name" class="categories_name">
